...
\item Ecran d'accueil et interface graphique disponible en jeu. Actions possibles: pause/continuer, restart, retour à l'écran d'accueil, choix du niveau (voir point suivant).
\item Niveaux décrits en XML: lisibilité, facilité d'édition.
