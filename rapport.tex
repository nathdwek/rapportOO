...
\item Des monstres se déplaçant de façon autonome et interragisant avec les blocs. 
...
\item Création de sol en pente. Le héro peut ainis se déplacer dans le niveau sur des platformes de hauteur différentes et donc de prendre des chemins différentes. 
